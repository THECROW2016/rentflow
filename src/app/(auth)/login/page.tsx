...
export default function LoginPage() {
  ...
  const [email, setEmail] = useState("owner@amaniproperties.co.ke");
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3.5 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
